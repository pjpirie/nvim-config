...
_G.packer_plugins = {
  ...
  gruvbox = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/gruvbox",
  ...
  ["hover.nvim"] = {
    ...
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/hover.nvim",
    url = "https://github.com/lewis6991/hover.nvim"
  },
  jester = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/jester",
    url = "https://github.com/David-Kunz/jester"
  },
  ["lsp-colors.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/lsp-colors.nvim",
  ...
  ["navigator.lua"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/navigator.lua",
  ...
  ["package-info.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/package-info.nvim",
  ...
  ripgrep = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/ripgrep",
    url = "https://github.com/BurntSushi/ripgrep"
  },
  tagbar = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/tagbar",
  ...
  ["vim-react-snippets"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/vim-react-snippets",
